        ...
        <div>
            ...
            <div className="container w-full hidden md:flex flex-row p-5 items-center sticky justify-center">
                ...
                <div className="w-fit items-center justify-center me-4 flex ms-auto flex-row gap-6">
                    ...
                    {
                        !isLogedIn ? <Link href={'/login'} className="px-5 py-2 border-2 bg-transparent border-violet-800 rounded-xl text-violet-800 hover:text-white hover:bg-violet-800 text-xl font-semibold">login</Link>
                            :
